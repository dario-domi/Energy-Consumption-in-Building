###############################################################################
# This script loads the emulated results of gas consumption for different months,
# and builds the implausibility measure for them. Non-implausible inputs are 
# compared with non-implausible inputs for the L2 difference of temperature time
# series (difference between observed and simulated temperatures)
################################################################################
